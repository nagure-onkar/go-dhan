          ...
          <View style={styles.row}>
            ...
            <View style={styles.col}>
              ...
              <TextInput
                ...
                onChangeText={(text) => setForm({ ...form, forWorkers: text })}
              />
            </View>
          </View>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={form.forCalf}
                onChangeText={(text) => setForm({ ...form, forCalf: text })}
              />
            </View>
            <View style={styles.col}>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={form.wastage}
                onChangeText={(text) => setForm({ ...form, wastage: text })}
              />
            </View>
            <View style={styles.col}>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.col}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={form.snf}
                onChangeText={(text) => setForm({ ...form, snf: text })}
              />
            </View>
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.col}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={form.salesFat}
                onChangeText={(text) => setForm({ ...form, salesFat: text })}
              />
            </View>
          </View>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={form.salesSnf}
                onChangeText={(text) => setForm({ ...form, salesSnf: text })}
              />
            </View>
            <View style={styles.col}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={form.orgRate}
                onChangeText={(text) => setForm({ ...form, orgRate: text })}
              />
            </View>
          </View>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                value={form.orgTotal}
                onChangeText={(text) => setForm({ ...form, orgTotal: text })}
              />
            </View>
